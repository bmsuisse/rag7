...
def filter_intent(
    ...
    body = (
        ...
        "(e.g. a product feature, attribute, or material name when "
        "no such field exists), set field=null and the runtime will "
        "match it against document content. NEVER force such an "
        "entity onto a name/supplier/brand field just because that "
        "field exists.\n"
        "- Negation flips the operator to NOT_CONTAINS / !=. The "
        "negated entity is the noun that follows the negator, NOT "
        "the search term that precedes it.\n"
